...
const images = [
  { src: require('../img/talent/jerome.png'), desc: 'Image 1' },
  { src: require('../img/talent/jeje.png'), desc: 'Image 2' },
  { src: require('../img/talent/artis2.png'), desc: 'Image 3' },
  { src: require('../img/talent/artis3.png'), desc: 'Image 4' },
  { src: require('../img/talent/randy.png'), desc: 'Image 5' },
  { src: require('../img/talent/aero.png'), desc: 'Image 6' },
  { src: require('../img/talent/gamers.png'), desc: 'Image 7' },
