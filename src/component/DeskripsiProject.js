...
const DeskripsiProject = () => {
  const allProjects = [
    ...
    { id: 1, title: "Project 7", image: require('../img/projectdetail/project1.png'), description: "Description for Project 1" },
    { id: 2, title: "Project 8", image: require('../img/projectdetail/project2.png'), description: "Description for Project 2" },
    { id: 3, title: "Project 9", image: require('../img/projectdetail/project3.png'), description: "Description for Project 3" },
